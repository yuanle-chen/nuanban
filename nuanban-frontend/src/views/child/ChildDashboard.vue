    ...
    <div class="bg-gradient-to-r from-blue-500 to-cyan-500 text-white p-6 pt-10 pb-16 rounded-b-3xl">
      <div class="flex items-center justify-between">
        <div>
          ...
          <h1 class="text-2xl font-bold mt-1">小张 👋</h1>
        </div>
    ...
    <div class="px-4 -mt-8">
      <div class="bg-white rounded-2xl p-5 shadow-md">
        <div class="flex items-center justify-between mb-4">
          <h2 class="text-lg font-semibold text-gray-800">妈妈的状态</h2>
        ...
        <div class="grid grid-cols-3 gap-4 text-center">
          <div>
            <p class="text-2xl font-bold text-green-500">正常</p>
            <p class="text-xs text-gray-500 mt-1">活动状态</p>
          </div>
          <div>
            <p class="text-2xl font-bold text-blue-500">8h</p>
            <p class="text-xs text-gray-500 mt-1">今日睡眠</p>
          </div>
          <div>
            <p class="text-2xl font-bold text-orange-500">2/3</p>
    ...
    <div class="px-4 mt-6">
      ...
      <div class="bg-white rounded-2xl shadow-md divide-y divide-gray-100">
        <div class="p-4 flex items-center gap-3">
          ...
          <div class="flex-1">
            <p class="font-medium text-gray-800">妈妈已服用降压药</p>
            <p class="text-xs text-gray-400">今天 08:30</p>
          </div>
        </div>
        <div class="p-4 flex items-center gap-3">
          <div class="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center text-xl">🏃</div>
          <div class="flex-1">
            <p class="font-medium text-gray-800">妈妈早上散步了30分钟</p>
            <p class="text-xs text-gray-400">今天 07:00</p>
          </div>
        </div>
      </div>
    </div>
